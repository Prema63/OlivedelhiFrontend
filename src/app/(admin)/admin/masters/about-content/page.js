...
import { Bold, Italic, Link, Image, Table, Quote, List, AlignLeft, AlignCenter, AlignRight, Save } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen  py-4 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-2xl font-semibold text-gray-900 mb-3">About Us</h1>
        ...
        <div className="bg-white rounded-lg shadow-sm">
          ...
          <div className="p-6 space-y-8">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <h2 className="text-lg font-medium text-gray-900 mb-6">About Us Content</h2>
